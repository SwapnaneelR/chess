        ...
        <div className="flex flex-col items-center text-center max-w-2xl ">
          ...
          <div className="mt-8 flex flex-col sm:flex-row gap-4">
            <button
              ...
              className="px-10 py-5 bg-yellow-700 hover:bg-yellow-700 text-white rounded-sm shadow-lg cursor-pointer transition-transform transform hover:scale-105"
            >
              Join Game
            </button>
            {isLoggedIn === true ? (
              <>
                <div
                  ...
                  className="px-10 py-5 bg-zinc-900 border-2 border-zinc-600 font-medium text-white rounded-sm shadow-lg cursor-pointer transition-transform transform hover:scale-105">
                   Profile
                </div>
              </>
            ) : (
